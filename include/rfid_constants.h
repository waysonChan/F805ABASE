...
typedef uint32_t  RFID_RADIO_OPERATION_MODE;
...
typedef uint32_t  RFID_RADIO_POWER_STATE;
...
typedef uint32_t  RFID_ANTENNA_PORT_STATE;
...
typedef uint32_t  RFID_18K6C_MODULATION_TYPE;
...
typedef uint32_t  RFID_18K6C_DATA_0_1_DIFFERENCE;
...
typedef uint32_t  RFID_18K6C_DIVIDE_RATIO;
...
typedef uint32_t  RFID_18K6C_MILLER_NUMBER;
...
typedef uint32_t RFID_RADIO_PROTOCOL;
...
typedef uint32_t  RFID_18K6C_MEMORY_BANK;
...
typedef uint32_t  RFID_18K6C_TARGET;
...
typedef uint32_t  RFID_18K6C_ACTION;
...
typedef uint32_t  RFID_18K6C_SELECTED;
...
typedef uint32_t  RFID_18K6C_INVENTORY_SESSION;
...
typedef uint32_t  RFID_18K6C_INVENTORY_SESSION_TARGET;
...
typedef uint32_t  RFID_18K6C_SINGULATION_ALGORITHM;
...
typedef uint32_t RFID_18K6C_WRITE_TYPE;
...
typedef uint32_t  RFID_18K6C_TAG_PWD_PERM;
...
typedef uint32_t  RFID_18K6C_TAG_MEM_PERM;
...
typedef uint32_t  RFID_18K6C_QT_OPT_CMD_TYPE;
...
typedef uint32_t  RFID_18K6C_QT_CTRL_TYPE;
...
typedef uint32_t  RFID_18K6C_QT_PERSISTENCE_TYPE;
...
typedef uint32_t  RFID_18K6C_QT_SR_TYPE;
...
typedef uint32_t  RFID_18K6C_QT_MEMMAP_TYPE;
...
typedef uint32_t RFID_RESPONSE_TYPE;
...
typedef uint32_t RFID_RESPONSE_MODE;
...
typedef uint32_t  RFID_MAC_RESET_TYPE;
...
typedef uint32_t  RFID_MAC_REGION;
...
typedef uint32_t RFID_REGISTER_TYPE;
...
typedef uint32_t RFID_REGISTER_ACCESS_TYPE;
 ...
 *        pins
 ******************************************************************************/
#define SET_BIT(location) (((uint32_t) 0x00000001) << location)
enum {
...
typedef uint32_t  RFID_RADIO_GPIO_PIN;
...
typedef uint32_t  RFID_BLOCKWRITE_MODE;
...
typedef uint32_t   RFID_TAG_FOCUS;
